...
class Actor(nn.Module):
    ...
    def __init__(self, state_size, action_size, seed=123, fc_units=256, fc_units1=128, fc_units2=128, fc_units3=64):
...
class Critic(nn.Module):
    ...
    def __init__(self, state_size, action_size, num_agent, seed=123, fc_units=256, fc_units1=128, fc_units2=128, fc_units3=64):
        """Initialize parameters and build model.
        Params
        ======
            state_size (int): Dimension of each state
